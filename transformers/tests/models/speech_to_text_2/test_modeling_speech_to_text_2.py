...
class Speech2Text2StandaloneDecoderModelTest(
    ...
    all_model_classes = (
        (Speech2Text2Decoder, Speech2Text2ForCausalLM) if is_torch_available() else ()
    )
    all_generative_model_classes = (
        (Speech2Text2ForCausalLM,) if is_torch_available() else ()
    )
    fx_compatible = True
    test_pruning = False
    ...
    def setUp(
        ...
        self.model_tester = Speech2Text2StandaloneDecoderModelTester(
