...
_SEQ_CLASS_EXPECTED_OUTPUT = (
    "'no'"  # TODO(anton) - could you quickly fine-tune a KS WavLM Model
)
_SEQ_CLASS_EXPECTED_LOSS = (
    0.7  # TODO(anton) - could you quickly fine-tune a KS WavLM Model
)
...
class WavLMPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(
            module, (WavLMEncoder, WavLMEncoderStableLayerNorm, WavLMFeatureEncoder)
        ):
