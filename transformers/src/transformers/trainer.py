...
class Trainer:
    ...
    def __init__(
        ...
        if (
            (self.sharded_ddp is not None) or args.deepspeed or (self.fsdp is not None)
        ...
        if args.torchdynamo:
            ...
            def get_ctx():
                ...
                if args.torchdynamo in ["fx2trt-fp16", "fx2trt"]:
                    ...
                    raise RuntimeError(
                        f"Torchdynamo backend {args.torchdynamo} is not supported."
                    )
        ...
        if not training:
            ...
            try:
                ...
                with ContextManagers(
                    [self.autocast_smart_context_manager(), torch.no_grad()]
                ):
    ...
    def init_git_repo(self, at_init: bool = False):
        ...
        if (
            ...
            with open(
                os.path.join(self.args.output_dir, ".gitignore"), "w", encoding="utf-8"
            ) as writer:
