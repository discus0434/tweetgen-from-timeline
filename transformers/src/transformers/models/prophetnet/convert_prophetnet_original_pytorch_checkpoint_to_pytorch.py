...
def convert_prophetnet_checkpoint_to_pytorch(
    prophetnet_checkpoint_path: str, pytorch_dump_folder_path: str
):
    """
    ...
    for key in loading_info["missing_keys"]:
        ...
        for attribute in attributes:
            ...
            if attribute == "weight":
                assert (
                    old_model.weight.shape == model.weight.shape
                ...
                if attribute == "query_proj":
                    model.query_proj.weight = nn.Parameter(
                        old_model.in_proj_weight[:embed_dim, :]
                    )
                    model.query_proj.bias = nn.Parameter(
                    ...
                    model.value_proj.bias = nn.Parameter(
