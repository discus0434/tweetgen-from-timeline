...
class TFElectraModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=ElectraConfig, hidden_size=37
        )
    ...
    def test_causal_lm_base_model_past_with_attn_mask(self):
        ...
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_causal_lm_base_model_past_with_attn_mask(
            *config_and_inputs
        )
    ...
    def test_causal_lm_base_model_past_with_large_inputs(self):
        ...
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_causal_lm_base_model_past_large_inputs(
            *config_and_inputs
        )
