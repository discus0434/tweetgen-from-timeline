...
class TFMarianEncoder(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.layers = [
            TFMarianEncoderLayer(config, name=f"layers.{i}")
...
class TFMarianDecoder(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.layers = [
            TFMarianDecoderLayer(config, name=f"layers.{i}")
...
class TFMarianMTModel(TFMarianPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def adjust_logits_during_generation(
        ...
        **kwargs,
        ...
        logits = tf.where(
            vocab_range == self.config.pad_token_id, LARGE_NEGATIVE, logits
        )
