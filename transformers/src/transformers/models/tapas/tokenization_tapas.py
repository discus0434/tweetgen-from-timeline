...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    name: 512 for name in PRETRAINED_VOCAB_FILES_MAP.keys()
}
PRETRAINED_INIT_CONFIGURATION = {
    name: {"do_lower_case": True} for name in PRETRAINED_VOCAB_FILES_MAP.keys()
}
...
class TapasTokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.max_column_id = (
            max_column_id if max_column_id is not None else self.model_max_length
        )
        self.max_row_id = (
            max_row_id if max_row_id is not None else self.model_max_length
        )
        ...
        **kwargs,
        ...
        for index, example in enumerate(
            ...
            outputs = self.prepare_for_model(
                ...
                verbose=verbose,
                prev_answer_coordinates=answer_coordinates[index - 1]
                if index != 0
                else None,
