...
class QuestionAnsweringTrainer(Trainer):
    ...
    def get_calib_dataloader(self, calib_dataset=None):
        ...
        calib_dataset = (
            calib_dataset if calib_dataset is not None else self.calib_dataset
        )

        calib_dataset = self._remove_unused_columns(
            calib_dataset, description="Calibration"
        )
