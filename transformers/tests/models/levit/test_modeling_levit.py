...
if is_torch_available():
    ...
    from transformers.models.levit.modeling_levit import (
...
class LevitModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=LevitConfig, has_text_modality=False, hidden_size=37
        )
...
class LevitModelIntegrationTest(unittest.TestCase):
    ...
    def default_feature_extractor(self):
        return LevitFeatureExtractor.from_pretrained(
            LEVIT_PRETRAINED_MODEL_ARCHIVE_LIST[0]
        )
