...
class MegatronBertModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=MegatronBertConfig, hidden_size=37
        )
    ...
    def test_for_masked_lm(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_megatron_bert_for_masked_lm(
            *config_and_inputs
        )

    def test_for_multiple_choice(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_megatron_bert_for_multiple_choice(
            *config_and_inputs
        )
    ...
    def test_for_pretraining(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_megatron_bert_for_pretraining(
            *config_and_inputs
        )

    def test_for_question_answering(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_megatron_bert_for_question_answering(
            *config_and_inputs
        )
    ...
    def test_inference_no_head(self):
        ...
        for ii in range(3):
            for jj in range(3):
                ...
                self.assertTrue(
                    math.isclose(a, b, rel_tol=TOLERANCE, abs_tol=TOLERANCE), msg=msg
                )
